...
@section('title', 'Complete your First Mediator account — Google Sign Up')
@section('description', 'Complete your First Mediator account setup after signing up with Google.')
