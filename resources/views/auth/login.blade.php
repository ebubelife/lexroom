...
<div class="p-8 rounded-xl shadow-lg" style="background-color: var(--bg-secondary); border: 1px solid var(--border-color);">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-4">
            <div class="flex items-center justify-between mb-2">
                <label for="password" class="text-sm font-medium" style="color: var(--text-primary);">Password</label>
    ...
    <div class="text-center">
        <p class="text-sm" style="color: var(--text-secondary);">
            ...
            <a href="{{ route('register') }}" class="font-medium hover:underline" style="color: var(--gold);">Create one</a>
        </p>
    </div>
</div>
@endsection