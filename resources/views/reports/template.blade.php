...
<body>
    ...
    <div class="disclaimer">
        ...
        This mediation report has been generated by Lex, an AI-powered mediation assistant. This report is provided for informational purposes only and does not constitute legal advice. The analysis, findings, and recommendations contained herein are based on the information provided during the mediation session and should not be relied upon as a substitute for professional legal counsel.
        <br><br>
        Both parties are strongly encouraged to consult with qualified legal professionals before making any decisions based on this report. FirstMediator and its AI systems do not provide legal representation, and this report does not create an attorney-client relationship.
        <br><br>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>Generated by FirstMediator AI Mediation Platform</p>
