...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                <strong>{{ $room->partyA->name }}</strong> has invited you to participate in a mediation session on LexRoom. 
        ...
        <!-- Footer -->
        <div class="footer">
            <p>© {{ date('Y') }} LexRoom. All rights reserved.</p>
