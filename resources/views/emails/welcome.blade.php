...
<head>
    ...
    <title>Welcome to LexRoom</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1 class="logo">LexRoom</h1>
        </div>
        
        <div class="content">
            <h1>Welcome to LexRoom, {{ $user->first_name }}! 🎉</h1>
            
            <p>Your account has been successfully verified and you're all set to start resolving disputes the smart way.</p>
            
            <div class="highlight">
                <strong>What is LexRoom?</strong><br>
                LexRoom is an AI-assisted legal dispute mediation platform that helps you resolve conflicts without expensive lawyers or lengthy court processes.
            </div>
        ...
        <div class="footer">
            <p><strong>LexRoom</strong> - Resolving disputes the smart way</p>
            <p>
                <a href="{{ config('app.url') }}">Visit Website</a> • 
                <a href="mailto:info@kodeblooded.com.ng">Contact Support</a>
            </p>
            <p style="margin-top: 15px; font-size: 12px;">
                © {{ date('Y') }} LexRoom. All rights reserved.
            </p>
        </div>
    </div>
</body>
